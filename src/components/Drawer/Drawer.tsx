    ...
    <ModalPortal>
      <div className="fixed top-0 right-0 z-20 flex items-center justify-end w-full h-screen bg-black md:hidden bg-opacity-60">
        ...
        >
          ...
          >
            <p className="text-2xl text-black font-main">main</p>
          </button>
          <button
            className={`${
          ...
          >
            <p className="text-2xl text-black font-main">translate</p>
          </button>
          <button
            className={`${
          ...
          >
            <p className="text-2xl text-black font-main">learn</p>
          </button>
          {auth ? (
            <button
            ...
            >
              <p className="text-2xl text-black font-main">sign in</p>
            </button>
          )}
        </div>
      </div>
